export const CAT_INFO = {
  name: "Muối",
  vietnameseName: "Muối",
  breed: "Anh Lông Ngắn Mix",
  age: "2 tuổi",
  personality: "Quý meow ỉa bậy đái khai không ai dám nhận số 1",
  hobbies: ["Cosplay the flash chạy quanh nhà", "Doạ đánh con sen", "Tranh  ăn với con sen", "Đái ỉa lung tung"],
  stats: {
    sleep: 16, // hours/day
  },
  gallery: [
